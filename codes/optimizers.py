...
def adam_weightnoise(lr, tparams_miu, tparams_sigma, grads_miu, grads_sigma, inp, cost):
    ...
    f_grad_shared = theano.function(inp, cost, updates=gsup_miu+gsup_sigma, profile=profile)
