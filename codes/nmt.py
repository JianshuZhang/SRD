...
from optimizers import adadelta, adam
...
def train(dim_word=100,  # word vector dimensionality
    ...
    f_grad_shared, f_update = eval(optimizer)(lr, tparams, grads, inps, cost_all)
    print 'Done'
    ...
    for eidx in xrange(max_epochs):
        ...
        for x, m, y, re, a, rea in train:
            ...
            if numpy.mod(uidx, validFreq) == 0 and eidx >= validStart:
                ...
                valid_err=valid_cer+1.*valid_recer
                ...
                print 'Valid CER: %.2f%%, relation_CER: %.2f%%' % (valid_cer,valid_recer)
